...
class IsihDanns:
    def __init__(self, input_size, hidden_size, lr, num_epochs_dim1, num_epochs_dim2):
        ...
        self.domain_optimizer_dim2 = optim.Adam(self.domain_classifier_dim2.parameters(), lr=lr)
        self.task_optimizer_dim2 = optim.Adam(self.task_classifier_dim2.parameters(), lr=lr)
    ...
    def fit_2nd_dim(self, source_loader, target_loader, test_target_X, test_target_y_task):
        self.feature_extractor, self.task_classifier_dim2, _ = utils.fit(
            ...
            self.feature_optimizer, self.domain_optimizer_dim2, self.task_optimizer_dim2, num_epochs=self.num_epochs_dim2, is_timeseries=False,
